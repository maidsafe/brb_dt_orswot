...
pub struct SBOrswot<M: Clone + Eq + std::hash::Hash + std::fmt::Debug + Serialize> {
    actor: Actor,
    orswot: orswot::Orswot<M, Actor>,
}

impl<M: Clone + Eq + std::hash::Hash + std::fmt::Debug + Serialize> SBOrswot<M> {
...
/*
impl SecureBroadcastAlgorithm
    for SBOrswot<u8>
{
    type Op = orswot::Op<u8, Actor>;
    type ReplicatedState = orswot::Orswot<u8, Actor>;
